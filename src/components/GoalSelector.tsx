            ...
            <form onSubmit={handleCreateCustomGoal} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 text-xs border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
                  required
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2 text-xs border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 bg-white"
                >
                  {skills.map((s) => (
                ...
                <p className="text-[10px] text-slate-500 mt-1">
                  The DAG topological engine will automatically trace all prerequisite ancestors required for this target.
                </p>
              </div>
