        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <select
              ...
              className="bg-white border border-slate-300 rounded-xl px-3 py-2 text-xs font-semibold text-slate-800 focus:outline-none focus:border-indigo-500 cursor-pointer shadow-2xs"
            >
              {skills.map((s) => (
            ...
            {assessmentMode === 'multiple_choice' && (
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer disabled:opacity-50"
                title="Generate new on-demand question using Gemini"
              >
                <Sparkles className={`w-3.5 h-3.5 text-indigo-600 ${generatingAiQuestion ? 'animate-spin' : ''}`} />
        ...
        {assessmentMode === 'multiple_choice' ? (
          loadingQuestions ? (
            <div className="py-20 text-center text-slate-500 space-y-3">
              <Cpu className="w-8 h-8 animate-spin text-indigo-600 mx-auto" />
            ...
            <>
              ...
              <div className="space-y-3 pt-2">
                {currentQuestion.options.map((opt) => {
                  ...
                  if (isSelected && !isSubmitted) {
                    optionStyles = 'border-indigo-600 bg-indigo-50/80 text-indigo-950 ring-1 ring-indigo-500/30 shadow-xs';
                  }
              ...
              {gradingResult === null && (
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="font-mono text-indigo-600 font-bold">{confidence} / 5</span>
                  </div>
              ...
              {gradingResult === null && (
                <button
                  ...
                  className="w-full py-3.5 px-6 rounded-xl bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold text-sm shadow-md shadow-indigo-500/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
                  {submitting ? (
                    <>
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <button
                      ...
                      disabled={loadingAi}
                      className="flex-1 py-3 px-4 rounded-xl bg-white hover:bg-slate-50 border border-indigo-300 text-indigo-700 text-xs font-bold transition-all flex items-center justify-center gap-2 cursor-pointer shadow-2xs"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 py-3 px-5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold shadow-md shadow-indigo-500/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
                    >
                      <span>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full p-4 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 text-xs sm:text-sm font-sans focus:outline-none focus:bg-white focus:border-indigo-500 leading-relaxed disabled:opacity-60"
              />
            </div>
            ...
            {openEndedResult === null && (
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="font-mono text-indigo-600 font-bold">{openEndedConfidence} / 5</span>
                </div>
                <div className="flex items-center justify-between gap-2 pt-1">
                  {[1, 2, 3, 4, 5].map((lvl) => (
                    <button
              ...
              <div className="space-y-4 pt-2">
                <div className="p-5 rounded-xl bg-white border border-slate-200 space-y-4 shadow-xs">
                  ...
                  {openEndedResult.updatedMastery && (
                    <div className="text-xs font-mono text-indigo-700 pt-2 border-t border-slate-100">
                ...
                <button
                  ...
                  className="w-full py-3 px-5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold shadow-xs transition-all cursor-pointer"
                >
