...
questions = [
    # Difficulty 1: Recall (q_cond_01 to q_cond_08)
    {
        "id": "q_cond_01",
        "skillId": "skill_cond_prob",
        "skillName": "Conditional Probability",
        "skillsTested": ["skill_cond_prob", "skill_prob"],
        "difficulty": 1,
        ...
        "options": [
            {"id": "opt_a", "text": "P(A and B) / P(B)"},
            {"id": "opt_b", "text": "P(A and B) / P(A)"},
            {"id": "opt_c", "text": "P(A) * P(B)"},
            {"id": "opt_d", "text": "P(A) + P(B) - P(B)"}
        ],
        "correctAnswer": "opt_a",
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "Prior probability (the initial belief in hypothesis H before observing evidence E)"},
            {"id": "opt_b", "text": "Posterior probability"},
            {"id": "opt_c", "text": "Likelihood"},
            {"id": "opt_d", "text": "Marginal evidence"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "Likelihood (the probability of observing evidence E assuming hypothesis H is true)"},
            {"id": "opt_b", "text": "Prior probability"},
            {"id": "opt_c", "text": "Posterior probability"},
            {"id": "opt_d", "text": "Normalizing constant"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "Sum_{i=1}^k [ P(A | B_i) * P(B_i) ]"},
            {"id": "opt_b", "text": "Product_{i=1}^k [ P(A | B_i) ]"},
            {"id": "opt_c", "text": "Sum_{i=1}^k [ P(A | B_i) / P(B_i) ]"},
            {"id": "opt_d", "text": "Max_{i=1}^k [ P(A | B_i) ]"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "P(A and B) = P(A | B) * P(B) = P(B | A) * P(A)"},
            {"id": "opt_b", "text": "P(A and B) = P(A | B) + P(B)"},
            {"id": "opt_c", "text": "P(A and B) = P(A | B) / P(B)"},
            {"id": "opt_d", "text": "P(A and B) = [P(A) + P(B)] / 2"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "Because conditioning on an event with measure 0 would result in division by zero, rendering the conditional probability undefined in standard probability"},
            {"id": "opt_b", "text": "Because events with probability 0 cannot exist physically"},
            {"id": "opt_c", "text": "Because conditional probabilities must always be integers"},
            {"id": "opt_d", "text": "Because P(A) would automatically equal zero"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "They are generally NOT equal; P(A|B) = P(B|A) * [P(A) / P(B)]"},
            {"id": "opt_b", "text": "They are always identical by commutative property of probability"},
            {"id": "opt_c", "text": "P(A|B) is always strictly larger than P(B|A)"},
            {"id": "opt_d", "text": "P(A|B) + P(B|A) = 1"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    # Difficulty 2: Comprehension (q_cond_09 to q_cond_16)
    {
        "id": "q_cond_09",
        "skillId": "skill_cond_prob",
        "skillName": "Conditional Probability",
        ...
        "options": [
            {"id": "opt_a", "text": "Confusing P(Evidence | Innocent) with P(Innocent | Evidence)"},
            {"id": "opt_b", "text": "Assuming an eyewitness is always 100% accurate"},
            {"id": "opt_c", "text": "Failing to account for measurement precision in DNA lab equipment"},
            {"id": "opt_d", "text": "Believing a suspect is guilty solely due to past criminal records"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "P(A and B | C) = P(A | C) * P(B | C)"},
            {"id": "opt_b", "text": "P(A and B) = P(A) * P(B)"},
            {"id": "opt_c", "text": "P(A | B) = P(C)"},
            {"id": "opt_d", "text": "P(C | A and B) = 1"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "skillId": "skill_cond_prob",
        "skillName": "Conditional Probability",
        "skillsTested": ["skill_cond_prob", "skill_prob", "skill_model_eval"],
        "difficulty": 2,
        "cognitiveCategory": "Comprehension",
        "text": "In a medical diagnostic test for a disease D, what does the 'Sensitivity' of the test represent?",
        "options": [
            {"id": "opt_a", "text": "P(Test Positive | Disease Present) — the true positive rate"},
            {"id": "opt_b", "text": "P(Disease Present | Test Positive) — positive predictive value"},
            {"id": "opt_c", "text": "P(Test Negative | Disease Absent) — specificity"},
            {"id": "opt_d", "text": "P(Disease Present) — prior prevalence"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "P(Test Negative | Disease Absent) — the true negative rate"},
            {"id": "opt_b", "text": "P(Disease Absent | Test Negative) — negative predictive value"},
            {"id": "opt_c", "text": "P(Test Positive | Disease Absent) — false positive rate"},
            {"id": "opt_d", "text": "P(Test Positive | Disease Present) — sensitivity"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "Even with high sensitivity and specificity, the posterior probability of disease given a positive test can remain surprisingly low due to false positives outnumbering true cases"},
            {"id": "opt_b", "text": "The posterior probability is always greater than 99% if sensitivity is 99%"},
            {"id": "opt_c", "text": "Prior probability has zero mathematical influence on posterior probability"},
            {"id": "opt_d", "text": "A rare prior forces sensitivity to drop to 0%"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "P(A and B and C) = P(A) * P(B | A) * P(C | A and B)"},
            {"id": "opt_b", "text": "P(A and B and C) = P(A) * P(B) * P(C)"},
            {"id": "opt_c", "text": "P(A and B and C) = P(A | B) * P(B | C) * P(C | A)"},
            {"id": "opt_d", "text": "P(A and B and C) = P(A) + P(B | A) + P(C | B)"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "FPR = 1 - Specificity"},
            {"id": "opt_b", "text": "FPR = 1 - Sensitivity"},
            {"id": "opt_c", "text": "FPR = Specificity / Sensitivity"},
            {"id": "opt_d", "text": "FPR = 1 / Specificity"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    # Difficulty 3: Application (q_cond_17 to q_cond_24)
    {
        "id": "q_cond_17",
        "skillId": "skill_cond_prob",
        "skillName": "Conditional Probability",
        ...
        "options": [
            {"id": "opt_a", "text": "Approximately 8.3% (0.009 / (0.009 + 0.099))"},
            {"id": "opt_b", "text": "90.0%"},
            {"id": "opt_c", "text": "81.0%"},
            {"id": "opt_d", "text": "50.0%"}
        ],
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "13/26 = 1/2 (50%)"},
            {"id": "opt_b", "text": "13/52 = 1/4 (25%)"},
            {"id": "opt_c", "text": "1/13"},
            {"id": "opt_d", "text": "26/52 = 1/2"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "37.5% (0.012 / 0.032)"},
            {"id": "opt_b", "text": "60.0%"},
            {"id": "opt_c", "text": "24.0%"},
            {"id": "opt_d", "text": "50.0%"}
        ],
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "20/50 = 40%"},
            {"id": "opt_b", "text": "20/100 = 20%"},
            {"id": "opt_c", "text": "20/50 = 50%"},
            {"id": "opt_d", "text": "30/50 = 60%"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "2/3 (66.7%)"},
            {"id": "opt_b", "text": "1/2 (50.0%)"},
            {"id": "opt_c", "text": "1/3 (33.3%)"},
            {"id": "opt_d", "text": "1.0 (100%)"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "Sum over x of [ x * P(X = x | Y = y) ]"},
            {"id": "opt_b", "text": "E[X] * E[Y]"},
            {"id": "opt_c", "text": "Sum over y of [ y * P(Y = y | X = x) ]"},
            {"id": "opt_d", "text": "E[X] / P(Y = y)"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "2/3 (approximately 66.7%)"},
            {"id": "opt_b", "text": "4/5 (80.0%)"},
            {"id": "opt_c", "text": "1/2 (50.0%)"},
            {"id": "opt_d", "text": "1/3 (33.3%)"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    # Difficulty 4: Analysis (q_cond_25 to q_cond_32)
    {
        "id": "q_cond_25",
        "skillId": "skill_cond_prob",
        "skillName": "Conditional Probability",
        ...
        "options": [
            {"id": "opt_a", "text": "Conditioning on a common collider effect induces a spurious negative correlation between two independent causes in the sampled subpopulation"},
            {"id": "opt_b", "text": "Assuming correlation implies causation in observational medical trials"},
            {"id": "opt_c", "text": "Failing to normalize likelihoods to sum to 1 in Bayesian estimation"},
            {"id": "opt_d", "text": "Overestimating the probability of rare conjunctive events"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "X and Y, which are marginally independent, become conditionally dependent given Z (collider unblocks the path)"},
            {"id": "opt_b", "text": "X and Y become conditionally independent"},
            {"id": "opt_c", "text": "Z becomes independent of both X and Y"},
            {"id": "opt_d", "text": "The causal directions reverse automatically"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "If a word never appeared with a class in training, P(Word | Class) = 0 wipes out the entire joint probability; Laplace smoothing adds pseudocount alpha to avoid zero probabilities"},
            {"id": "opt_b", "text": "Words with zero syllables cause division by zero during vectorization"},
            {"id": "opt_c", "text": "Zero-frequency words cause infinite gradient descent loops"},
            {"id": "opt_d", "text": "It eliminates rare words by pruning them entirely from vocabulary"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "Yes; for example, two independent fair coins X and Y, with Z = X XOR Y. X and Y are independent, but given Z, knowing X determines Y"},
            {"id": "opt_b", "text": "No; marginal independence mathematically guarantees conditional independence for all conditioning variables"},
            {"id": "opt_c", "text": "Yes, but only if Z is an unmeasurable set"},
            {"id": "opt_d", "text": "No; independence is an immutable invariant under conditioning"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "P(E | H_1) / P(E | H_2)"},
            {"id": "opt_b", "text": "P(H_1) / P(H_2)"},
            {"id": "opt_c", "text": "P(H_1 | E) / P(H_2 | E)"},
            {"id": "opt_d", "text": "P(E and H_1) / P(E and H_2)"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "Var(X) = E[Var(X | Y)] + Var(E[X | Y])"},
            {"id": "opt_b", "text": "Var(X) = Var(X | Y) + Var(Y)"},
            {"id": "opt_c", "text": "Var(X) = E[Var(X | Y)] * Var(E[X | Y])"},
            {"id": "opt_d", "text": "Var(X) = E[X | Y]^2 - Var(Y)"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "Because C is a non-collider on the path, so conditioning on C renders X and Y conditionally independent along that path, removing confounding bias"},
            {"id": "opt_b", "text": "Because conditioning on C deletes the nodes X and Y from the graph"},
            {"id": "opt_c", "text": "Because C becomes a collider when conditioned upon"},
            {"id": "opt_d", "text": "Because it reverses the causal arrows pointing away from C"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "The posterior distribution becomes increasingly dominated by the data likelihood, and the influence of the prior vanishes (Bernstein-von Mises theorem)"},
            {"id": "opt_b", "text": "The prior distribution completely overrides the data"},
            {"id": "opt_c", "text": "The posterior variance approaches positive infinity"},
            {"id": "opt_d", "text": "The posterior probability collapses to zero everywhere"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    # Difficulty 5: Synthesis (q_cond_33 to q_cond_40)
    {
        "id": "q_cond_33",
        "skillId": "skill_cond_prob",
        "skillName": "Conditional Probability",
        ...
        "options": [
            {"id": "opt_a", "text": "P(X_1, ..., X_n) = Product_{i=1}^n P(X_i | Parents(X_i))"},
            {"id": "opt_b", "text": "P(X_1, ..., X_n) = Product_{i=1}^n P(X_i | Children(X_i))"},
            {"id": "opt_c", "text": "P(X_1, ..., X_n) = Sum_{i=1}^n P(X_i | Parents(X_i))"},
            {"id": "opt_d", "text": "P(X_1, ..., X_n) = Product_{i=1}^n [ P(X_i) / P(Parents(X_i)) ]"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "skillId": "skill_cond_prob",
        "skillName": "Conditional Probability",
        "skillsTested": ["skill_cond_prob", "skill_prob_dist"],
        "difficulty": 5,
        "cognitiveCategory": "Synthesis",
        ...
        "options": [
            {"id": "opt_a", "text": "Beta(alpha + k, beta + n - k)"},
            {"id": "opt_b", "text": "Beta(alpha * k, beta * (n - k))"},
            {"id": "opt_c", "text": "Binomial(n, (alpha + k) / (alpha + beta + n))"},
            {"id": "opt_d", "text": "Beta(alpha + n, beta + k)"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "X's parents, X's children, and all other parents of X's children (spouses)"},
            {"id": "opt_b", "text": "X's immediate parents and immediate children only"},
            {"id": "opt_c", "text": "All ancestors and descendants of X"},
            {"id": "opt_d", "text": "All nodes sharing the same topological rank as X"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "It computes the expectation of the complete-data log-likelihood with respect to the latent variables Z conditioned on the observed data X and current parameter estimates theta"},
            {"id": "opt_b", "text": "It directly updates the parameter estimates theta using closed-form gradient descent"},
            {"id": "opt_c", "text": "It eliminates all noise from observed variables X"},
            {"id": "opt_d", "text": "It guarantees that the log-likelihood reaches the global optimum in one iteration"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "By recursively computing alpha_t(j) = P(y_{1:t}, X_t = j) through dynamic programming: summing transition probabilities weighted by alpha_{t-1} and multiplying by emission probability P(y_t | X_t = j)"},
            {"id": "opt_b", "text": "By inverting the emission covariance matrix using singular value decomposition"},
            {"id": "opt_c", "text": "By sampling paths using rejection Monte Carlo"},
            {"id": "opt_d", "text": "By assuming hidden states are strictly independent across time"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "p(theta) proportional to sqrt(det(I(theta))) where I(theta) is the Fisher Information matrix; it is invariant under differentiable reparameterization of the parameter space"},
            {"id": "opt_b", "text": "A uniform prior p(theta) = constant; invariant only under linear shifts"},
            {"id": "opt_c", "text": "A Gaussian prior with infinite variance; invariant under scaling"},
            {"id": "opt_d", "text": "A prior that maximizes entropy subject to moment constraints"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "do(X = x) actively cuts all incoming causal arrows into X (graph mutilation), eliminating spurious backdoor correlations from confounders; P(Y | X = x) passively filters data across all existing trails"},
            {"id": "opt_b", "text": "They are mathematically equivalent in all observational datasets"},
            {"id": "opt_c", "text": "do(X = x) divides the conditional probability by the variance of X"},
            {"id": "opt_d", "text": "do(X = x) requires all variables to be normally distributed"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
    ...
    },
    {
        ...
        "options": [
            {"id": "opt_a", "text": "E[X | G] is defined as the Radon-Nikodym derivative of the signed measure nu(A) = integral_A X dP with respect to the probability measure P restricted to G"},
            {"id": "opt_b", "text": "It computes the numerical gradient of conditional density using finite difference approximations"},
            {"id": "opt_c", "text": "It proves that continuous distributions must have compact support"},
            {"id": "opt_d", "text": "It converts Lebesgue integrals into discrete Riemann sums"}
        ],
        "correctAnswer": "opt_a",
        "distractorRationales": {
...
def main():
    out_file = os.path.join(os.path.dirname(__file__), '../server/data/questions/conditionalProbability.ts')
    with open(out_file, 'w', encoding='utf-8') as f:
        f.write("import { SeedQuestionDefinition } from '../questionBank.js';\n\n")
        f.write("export const CONDITIONAL_PROBABILITY_QUESTIONS: SeedQuestionDefinition[] = ")
        f.write(json.dumps(questions, indent=2))
        f.write(";\n")
    print(f"Generated {len(questions)} Conditional Probability questions in {out_file}")
